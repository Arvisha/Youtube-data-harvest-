...
with col1:
    ...
    if Get_data or st.session_state.Get_state:
        ...
        api_version = 'v3'
        api_key = 'AIzaSyBbcGlA9NcMzQUOV2_hFQeCD4fvOXECly4'
...
with col2:
    ...
    if Migrate or st.session_state_migrate_sql:
        ...
        engine = create_engine('mysql+mysqlconnector://root:Arvi%402000@localhost/youtube_database', echo=False)
...
connect_for_question = pymysql.connect(host='localhost', user='root', password='Arvi@2000', db='youtube_database')
